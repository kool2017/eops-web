    ...
    routes: [{
        ...
        },
        {
            ...
            children: [{
                ...
                {
                    path: '/comm/wkf/approve',
                    component: resolve => require(['../components/page/comm/wkf/approve/setting/Setting.vue'], resolve)
                },
                {
                    path: '/comm/wkf/agent',
                    component: resolve => require(['../components/page/comm/wkf/approve/agent/Agent.vue'], resolve)
                },
                {
                    path: '/comm/wkf/schedule',
                    component: resolve => require(['../components/page/comm/wkf/approve/schedule/Schedule.vue'], resolve)
                },
                {
                    path: '/comm/wkf/record',
                    component: resolve => require(['../components/page/comm/wkf/approve/record/Record.vue'], resolve)
                }
            ]
        },
        {

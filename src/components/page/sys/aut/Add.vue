<template>
    ...
    <el-dialog title="增加权限" :visible.sync="visible" :close-on-click-modal="false" :before-close="modalClose">
                    ...
                    <el-row :gutter="10">
                        <el-col :span="10">
                            <el-form-item label="权限编码:" prop="autCode">
                                <el-input v-model="addInfo.autCode" size="small" maxlength="10"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="10" :offset="1">
                            <el-form-item label="权限名称:" prop="autName">
                                <el-input v-model="addInfo.autName" size="small" maxlength="100"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </div>
            ...
            return {
                ...
                addRules: {
                    autCode: [
                        ...
                        {max: 8, message: '最大长度10', trigger: 'blur'}
                    ],
                    autName: [
